...
SCENARIOS = {
    "한식": "한식 두 가지(식단 A / 식단 B) 7일치 식단을 보고 설문에 응답해주세요.",
    "중식": "중식 두 가지(식단 A / 식단 B) 7일치 식단을 보고 설문에 응답해주세요.",
    "일식": "일식 두 가지(식단 A / 식단 B) 7일치 식단을 보고 설문에 응답해주세요.",
    "양식": "양식 두 가지(식단 A / 식단 B) 7일치 식단을 보고 설문에 응답해주세요.",
}
