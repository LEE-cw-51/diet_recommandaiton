...
class DailyDietOptimizer:
    def __init__(self, data_path=DATA_PATH):
        print("⚙️ AI 추천 엔진 초기화 중 (v1.6 Debugged)...")
...
if __name__ == "__main__":
    ...
    if isinstance(result, str):
        ...
        print("\n==================================================")
        print(f"🥗 [AI 추천 결과] {MEALS}끼 식단 (v1.6 Debugged) | 목표: {USER_GOAL}")
        print("==================================================")
