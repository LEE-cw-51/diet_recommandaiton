...
class DailyDietOptimizer:
    def __init__(self, data_path=DATA_PATH):
        print("⚙️ AI 추천 엔진 초기화 중 (v2.8.8: Concretized User Data)...")
    ...
    def recommend_daily_diet(self, target_cal, target_prot, target_fat, user_goal, allergies_to_avoid=[], excluded_codes=None, excluded_brands=None, **kwargs):
        ...
        fat_max_factor = kwargs.get('fat_max_factor', 1.3)
        ...
        sorted_results = [all_candidate_results[i] for i in sorted_indices]
...
if __name__ == "__main__":
    ...
    print(f"\n🚀 [Parallel] {NUM_USERS}명 시뮬레이션 시작 (v2.8.7: Multiple Alternatives Added)")
